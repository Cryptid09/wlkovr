...
| AI/NLU (multilingual extraction, embeddings, summaries) | **Gemini 3.6 Flash** (via `github.com/google/generative-ai-go`), structured output mode & **`gemini-embedding-001`** (3072-dim). *`text-embedding-004` 404s on the v1beta endpoint this SDK uses — do not switch back.* |
